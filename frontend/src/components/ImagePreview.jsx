  ...
  return (
    <div className="flex flex-col gap-3 group">
      <div className="relative aspect-video bg-slate-800 rounded-2xl overflow-hidden border border-slate-700 shadow-xl">
        ...
        {!processed && whatsappSettings.enabled && (
          <div 
            ...
            style={{ 
              ...
              fontSize: `${whatsappSettings.fontSize / 2}px` // Scaled for preview
            }}
          >
        ...
        {processed && (
          <div className="absolute inset-0 bg-primary-950/40 backdrop-blur-sm flex flex-col items-center justify-center animate-in fade-in duration-500">
            ...
            <div className="mt-4 flex gap-2">
              <a 
                href={processed.processedUrl} 
                download 
                className="bg-primary-600 hover:bg-primary-500 p-2 rounded-full transition-all"
              >
        ...
        {/* Hover Info */}
        {!processed && (
          <div className="absolute top-2 right-2 bg-black/50 backdrop-blur-md px-2 py-1 rounded-md text-[10px] opacity-0 group-hover:opacity-100 transition-opacity">
            Live Preview
          </div>
        )}
      </div>
      ...
      <div className="px-2 flex justify-between items-center">
        ...
        {processed && <span className="text-[10px] text-primary-500 font-bold uppercase">Ready</span>}
      </div>
    </div>
  );
};
